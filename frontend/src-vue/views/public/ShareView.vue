...
<style scoped>
.share-page{min-height:calc(100dvh - 56px);background:#fff;padding:0 0 72px;color:#262626}.initial-loading{display:grid;min-height:55vh;place-content:center;justify-items:center;gap:16px;color:#8a8f8d}.share-state{width:min(440px,calc(100% - 32px));margin:8vh auto 0;border:1px solid #e7e9e8!important;border-radius:8px!important;text-align:center;box-shadow:0 12px 34px rgba(0,0,0,.06)!important}.share-state h1{margin:18px 0 7px;font-size:26px}.share-state p{color:#8a8f8d}.share-state :deep(.v-btn){border-radius:5px;letter-spacing:0;text-transform:none}.shared-reader{width:100%;margin:0}.reader-progress{position:sticky;top:56px;z-index:31}.shared-bar{position:sticky;top:56px;z-index:30;display:flex;min-height:48px;align-items:center;justify-content:space-between;gap:12px;border-bottom:1px solid #f0f0f0;background:rgba(255,255,255,.96);padding:7px 22px}.summary,.actions{display:flex;align-items:center;gap:7px;flex-wrap:wrap}.summary strong{font-size:13px}.summary small{color:#8a8f8d;font-size:12px}.summary :deep(.v-chip){height:24px;border-radius:4px;font-size:11px}.actions :deep(.v-btn){height:30px;border-radius:4px;letter-spacing:0;text-transform:none}.alert-row{display:flex;align-items:center;justify-content:space-between;gap:12px}.shared-reader>.v-alert{width:min(860px,calc(100% - 32px));margin:14px auto!important}.shared-layout{width:750px;max-width:calc(100% - 40px);margin:auto}.shared-layout.with-catalog{display:grid;width:100%;max-width:none;grid-template-columns:260px minmax(0,1fr);gap:0}.shared-layout>aside{position:sticky;top:104px;height:calc(100dvh - 104px);overflow:auto;border-right:1px solid #e7e9e8;background:#fafbfb;padding:16px 10px}.shared-layout>aside>header{display:flex;gap:10px;padding:5px 7px 13px}.shared-layout>aside>header>span{font-size:25px}.shared-layout>aside>header strong{font-size:14px}.shared-layout>aside p{margin:3px 0;color:#8a8f8d;font-size:12px}.shared-layout>aside :deep(.v-list){background:transparent}.shared-layout>aside :deep(.v-list-item){min-height:35px;border-radius:4px!important;padding-inline:8px}.shared-layout>aside :deep(.v-list-item-title){font-size:13px}.shared-layout>aside :deep(.v-list-item-subtitle){display:none}.catalog-empty{padding:22px 8px;color:#8a8f8d;text-align:center}.mobile-picker{display:none;margin:14px 16px 0}.content-column{width:750px;max-width:calc(100% - 40px);min-width:0;margin:0 auto;padding:62px 0 0}.content-card{min-height:420px;background:#fff}.content-card>header{margin-bottom:44px}.page-icon{display:block;margin-bottom:13px;font-size:40px}.content-card h1{margin:0 0 13px;overflow-wrap:anywhere;font-size:40px;font-weight:700;line-height:1.28;letter-spacing:-.6px}.content-card header p,.empty-content p{color:#8a8f8d;font-size:12px}.labels{display:flex;flex-wrap:wrap;gap:6px}.labels :deep(.v-chip){height:24px;border-radius:4px}.content-card :deep(.public-content-renderer){font-size:16px;line-height:1.8}.copy-disabled{user-select:none;-webkit-user-select:none}.empty-content{border:1px dashed #d8dad9!important;border-radius:6px!important;padding:52px 24px!important;text-align:center}.comments-card{margin-top:68px;border-top:1px solid #e7e9e8;padding:26px 0 0!important}.comments-heading{display:flex;justify-content:space-between;gap:14px;margin-bottom:18px}.comments-heading>div{display:flex;gap:10px}.comments-heading h2{margin:0;font-size:17px}.comments-heading p{margin:2px 0;color:#8a8f8d;font-size:12px}.comments-state{display:flex;min-height:100px;align-items:center;justify-content:center;gap:9px;color:#8a8f8d}.comment-list{display:grid;gap:17px;margin-bottom:20px}.thread{border-bottom:1px solid #f0f0f0;padding-bottom:17px}.comment{display:flex;align-items:flex-start;gap:10px}.comment-body{min-width:0;flex:1}.comment-body header{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.comment-body time{color:#a6aaa8;font-size:12px}.comment-body p{margin:7px 0;overflow-wrap:anywhere;white-space:pre-wrap;line-height:1.65}.reply{margin:13px 0 0 44px;border-radius:5px;background:#f7f8f8;padding:12px}.composer{border-top:1px solid #e7e9e8;padding-top:18px}.reply-banner{display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;border-radius:4px;background:#edf3ff;color:#245bc3;padding:7px 10px}.composer-footer,.comments-login{display:flex;align-items:center;justify-content:space-between;gap:14px;margin-top:11px}.composer-footer small,.comments-login p{color:#8a8f8d}.comments-login{border-radius:5px;background:#f7f8f8;padding:14px}.comments-login p{margin:3px 0 0}
@media(max-width:900px){.shared-layout.with-catalog{display:block}.shared-layout>aside{display:none}.mobile-picker{display:block}.shared-bar{align-items:flex-start;flex-direction:column}.actions{width:100%}.content-column{padding-top:42px}.reply{margin-left:20px}.comments-login,.composer-footer{align-items:stretch;flex-direction:column}}
@media(max-width:520px){.share-state{padding:24px!important}.shared-bar{padding-inline:12px}.actions{display:grid}.actions :deep(.v-btn){width:100%}.alert-row{align-items:flex-start;flex-direction:column}.shared-layout,.content-column{max-width:calc(100% - 30px)}.content-card h1{font-size:32px}.comments-card{padding-top:20px!important}.reply{margin-left:8px}}
</style>
